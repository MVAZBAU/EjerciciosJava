 ...
 ** Descripción:        Para la tarea se requiere un menú para administrar a los productos con las opciones:
 ...
 *                      operación, puede ser con la clase Scanner indicando una lista con las opciones, cada opción
 *                      asociada a un numero. O bien! otra forma mucho mejor seria usando la clase JOptionPane para un
 *                      menú con interfaces graficas de la siguiente forma:
 *                      int opcionIndice = 0;
 ...
 *                      Para eliminar el mensaje "Usuario eliminado correctamente" y así sucesivamente dependiendo de
 *                      la opción.
 ...
 *                      con otra, al finalizar con la opción salir (5) se debe mostrar el mensaje
 *                      "Haz salido con exito!" y finalizar el programa.
 *
 ** Retorna:
 **
